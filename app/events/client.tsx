...
const fallbackEvents: TransformedEvent[] = [
  ...
  },
  {
    ...
    location: "Register to See Address, Singapore",
    type: "Workshop",
    attendees: "59 Going",
    description:
      "Build your first web app in an intensive hands-on workshop. No coding experience needed. By the end, you'll have shipped a real product using Claude Desktop. Follow along step-by-step as we build together.",
  ...
  },
  {
    ...
    attendees: "25 max",
    description:
      "Hands-on workshop for business owners and salespeople. Configure your own OpenClaw sales assistant that handles lead generation, content creation, CRM updates, scheduling, and follow-ups. Walk away with a fully functional AI sales assistant.",
  ...
  },
  {
    ...
    attendees: "Coming soon",
    description:
      "Build real AI agents using the Affinidi Trust Graph and Agent SDK. Hands-on lab with partner pitches and panel Q&A. Walk out with Early Access credentials to the Affinidi platform. Dinner included.",
    link: "https://luma.com/2lv08v20",
    imageUrl: null,
    featured: true,
  },
  {
    id: "openclaw-hackathon",
    ...
    attendees: "Coming soon",
    description:
      "Build something real in one evening. Turn OpenClaw into a working growth engine with founders, builders, and operators. Hands-on building, fast feedback, and a community that ships. Food & drinks included.",
    ...
    <div className="min-h-screen bg-white pt-20 sm:pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <div className="mb-12">
          <div>
            <iframe
              src="https://luma.com/embed/calendar/cal-KNN5iOtlTsVqaaf/events"
              width="100%"
              height="450"
              frameBorder="0"
        ...
        {/* {error && !loading && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-amber-700 text-xs">
              <strong>Tip:</strong> Luma API now requires Luma Plus ($59/month).
              You can use the embed widget above for free, or manually manage
              events.
            </p>
          </div>
        )} */}
            ...
            {filteredEvents.length > 0 ? (
              ...
              >
                ...
                <p className="text-slate-500 font-medium">
                  No {selectedType !== "All" ? selectedType.toLowerCase() : ""}{" "}
                  events found.
                </p>
              </motion.div>
            )}
        ...
        >
          <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-8 sm:p-12 border border-slate-200">
            ...
            <p className="text-slate-600 mb-6 max-w-2xl mx-auto font-light">
              Want to host an event? Reach out to our team and we'll help you
              organize and promote it to our community.
            </p>
