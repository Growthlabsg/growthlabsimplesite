...
export const metadata: Metadata = {
  ...
  description:
    "Join our events, workshops, and networking sessions to connect, learn, and grow with the community. Monthly networking mixers, startup workshops, investor pitch sessions, and conferences in Singapore and online.",
  keywords: [
    "startup events",
