...
export default function About2() {
  return (
    <section
      id="about"
      className="relative py-16 sm:py-24 lg:py-32 xl:py-40 bg-gradient-to-b from-white via-slate-50/50 to-white overflow-hidden"
    >
          ...
          >
            ...
            <div className="space-y-8 max-w-4xl">
              ...
              >
                Through{" "}
                <strong className="font-semibold text-slate-900">
                  AI-driven tools, mentorship programs, startup resources, and a
                  vibrant professional network
                </strong>
                , GrowthLab bridges the gap between innovation and opportunity.
              </motion.p>
