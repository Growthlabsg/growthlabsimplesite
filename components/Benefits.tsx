...
const businessInBox = [
  {
    ...
    description:
      "Incorporation, corporate secretarial services, business registration.",
  },
  {
    name: "Compliance & Filings",
    description: "ACRA/IRAS filings, annual returns, regulatory compliance.",
  },
  {
    name: "Accounting & Tax",
    description: "Bookkeeping, tax planning, financial reporting.",
  },
  {
    name: "Banking & Payments",
    description:
      "Business account setup, multi-currency accounts, payment solutions.",
  },
  {
    name: "HR & Legal Support",
    description:
      "Staff augmentation, payroll, work pass applications, legal consultation.",
  },
  {
    name: "Intellectual Property",
    description: "Trademark registration, patent filing, IP protection.",
  },
  {
  ...
  },
  {
    ...
    description: "Software development, cloud infrastructure, cybersecurity.",
  },
  {
    name: "Virtual Office & Admin",
    description: "Virtual address, administrative support, mail handling.",
  },
];

export default function Benefits() {
  return (
    <section className="framer-motion-optimized relative py-16 sm:py-24 lg:py-32 xl:py-40 bg-slate-900 overflow-hidden">
      {/* Background Video */}
      <div
      ...
      {/* Background gradient */}
      <div
        className="absolute inset-0 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 opacity-90 z-10 pointer-events-none"
        style={{ isolation: "isolate" }}
      />
      <div
        className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-20 z-10 pointer-events-none"
        style={{ isolation: "isolate" }}
      />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
          ...
          >
            <span className="text-6xl sm:text-7xl lg:text-8xl font-bold text-gray-800 block leading-none">
              09
            </span>
            <motion.div
          ...
          >
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 max-w-3xl leading-relaxed font-light">
              GrowthLab empowers founders, investors, students, and innovators
              to connect, launch, and grow their ventures faster and smarter.
            </p>
          </motion.div>
        </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 font-light max-w-2xl mx-auto">
              All the essential services and resources you need to launch and
              scale your startup, all in one place with exclusive member
              discounts.
            </p>
          </div>
