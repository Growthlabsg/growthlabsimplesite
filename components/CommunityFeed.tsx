...
import { Heart, MessageCircle, Share2, MoreVertical, Play, X } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-slate-600 max-w-3xl leading-relaxed font-light">
              See what our community is sharing. Real updates, stories, and moments from founders, investors, and innovators.
            </p>
          </motion.div>
        </div>
          ...
          {visiblePosts.map((post, index) => {
            ...
            return (
              <motion.article
                ...
                className="break-inside-avoid mb-6 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300 overflow-hidden group"
              >
                {/* Post Header */}
                <div className="p-4 pb-3 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-slate-900 text-sm truncate">{post.user.name}</p>
                ...
                {isTextPost ? (
                  <div className="px-4 pb-4">
                    <p className="text-slate-700 leading-relaxed text-sm font-light">{post.content}</p>
                  </div>
                ) : (
                ...
                {!isTextPost && (
                  <div className="px-4 pt-3 pb-2">
                    <p className="text-slate-700 text-sm font-light leading-relaxed line-clamp-2">{post.content}</p>
                  </div>
                )}
