      ...
      >
        ...
        <div className="relative z-10 mb-6 flex justify-center">
          ...
          >
            ...
            />
            <Icon
              className={`${feature.iconColor} relative z-10 group-hover:scale-110 transition-transform duration-300`}
              size={40}
            />
          </motion.div>
        </div>
        ...
        {/* Learn More Link */}
        <motion.div className="relative z-10 flex items-center justify-center gap-2 text-primary font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
...
export default function Features() {
  ...
  const featuresListSchema = getItemListSchema({
    ...
    description:
      "Comprehensive list of features available on the GrowthLab startup ecosystem platform",
    ...
    items: [
      {
        ...
        description: "Connect with founders, investors & innovators",
      },
      {
        name: "Business Pages",
        description: "Build & showcase your startup profile",
      },
      {
        name: "Share Updates",
        description: "Post milestones, news & announcements",
      },
      {
        name: "Raise Funding",
        description: "Access investors & funding opportunities",
      },
      { name: "Post Jobs", description: "Discover talent & build your team" },
      {
        name: "Mentorship",
        description: "Get guidance from experienced founders",
      },
  ...
  return (
    <>
      ...
      <section
        id="features"
        className="relative py-16 sm:py-24 lg:py-32 xl:py-40 bg-white overflow-hidden framer-motion-optimized"
      >
        <div
          className="absolute inset-0 bg-gradient-to-b from-white via-slate-50/30 to-white pointer-events-none"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-slate-600 font-light">
                Everything you need to turn your idea into a scalable venture —
                all in one platform.
              </p>
            </motion.div>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Connect with founders, investors & innovators",
                },
                {
                  icon: Briefcase,
                  title: "Business Pages",
                  desc: "Build & showcase your startup profile",
                },
                {
                  icon: Sparkles,
                  title: "Share Updates",
                  desc: "Post milestones, news & announcements",
                },
                {
                  icon: DollarSign,
                  title: "Raise Funding",
                  desc: "Access investors & funding opportunities",
                },
                {
                  icon: Users,
                  title: "Post Jobs",
                  desc: "Discover talent & build your team",
                },
                {
                  icon: GraduationCap,
                  title: "Mentorship",
                  desc: "Get guidance from experienced founders",
                },
                {
                  icon: Rocket,
                  title: "AI Tools",
                  desc: "Leverage AI-driven startup resources",
                },
                {
                  icon: Network,
                  title: "Find Partners",
                  desc: "Discover strategic partnerships",
                },
              ].map((item, i) => {
