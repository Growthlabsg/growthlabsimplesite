          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
            ...
            >
              ...
              <p className="text-xl sm:text-2xl text-slate-600 max-w-3xl leading-relaxed font-light">
                The visionary leaders behind GrowthLab and the passion driving
                our global startup ecosystem.
              </p>
            </motion.div>
          </div>
            ...
            >
              ...
              >
                ...
                <p className="text-xl text-slate-700 font-light leading-relaxed relative z-10">
                  ...
                  to turn their ideas into reality. We're building more than a
                  platform—we're creating an ecosystem where startups thrive."
                </p>
              </motion.div>
              ...
              <div className="space-y-4">
                <p className="text-lg text-slate-700 leading-relaxed font-light">
                  Arul Murugan is a passionate entrepreneur and startup
                  ecosystem builder with a deep commitment to empowering
                  founders, investors, students, and innovators worldwide.
                  Through GrowthLab, he has created a comprehensive platform
                  that combines community, education, funding, and technology to
                  help early-stage entrepreneurs succeed.
                </p>
                <p className="text-lg text-slate-700 leading-relaxed font-light">
                  With a vision to create "LinkedIn for startups," Arul has
                  built GrowthLab into a vibrant global ecosystem with 2,500+
                  members across 50+ countries. The platform facilitates
                  networking, business development, funding opportunities, and
                  access to essential startup resources—all in one place.
                </p>
                <p className="text-lg text-slate-700 leading-relaxed font-light">
                  Beyond GrowthLab, Arul is dedicated to building communities
                  and fostering innovation. He believes in the power of
                  connections and the transformative impact of bringing together
                  passionate entrepreneurs from around the world to collaborate,
