...
export default function Hero() {
  ...
  const growthLabDefinition = getDefinitionSchema({
    ...
    definition:
      "GrowthLab is a global startup ecosystem platform that combines community, education, funding, and technology to help early-stage entrepreneurs turn ideas into scalable ventures. Based in Singapore, serving 2,500+ members across 50+ countries.",
    alternateNames: [
      "GrowthLab Singapore",
      "GrowthLab Platform",
  ...
  const heroSpeakable = getSpeakableSpecification({
    cssSelector: ["h1", ".hero-subtitle", ".hero-description"],
  });

  return (
    <>
      <StructuredData data={[growthLabDefinition, heroSpeakable]} />
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-slate-50 to-white pt-20 overflow-hidden framer-motion-optimized">
