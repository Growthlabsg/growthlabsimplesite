      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
          ...
          >
            ...
            <p className="text-lg text-slate-500 font-light">
              From joining the ecosystem to launching and growing your startup — we've got you covered.
            </p>
          </motion.div>
        </div>
                  ...
                  <div className="lg:col-span-8">
                    <div className="bg-white rounded-2xl p-8 border border-slate-200 hover:border-primary/50 transition-all duration-500 hover:shadow-xl">
                      <div className="flex items-center gap-3 mb-4">
                        <span className="lg:hidden text-4xl font-bold text-primary/20">{item.step}</span>
                        <h3 className="text-2xl sm:text-3xl font-bold text-slate-900">{item.title}</h3>
                      </div>
        ...
        >
          <div className="inline-block bg-gradient-to-br from-primary/10 to-amber/10 rounded-2xl p-10 border border-primary/20">
            <p className="text-2xl font-semibold text-slate-900 mb-4">Ready to get started?</p>
            <p className="text-slate-600 font-light mb-6">Join GrowthLab today and start building your startup ecosystem.</p>
            <motion.a
              href="/register"
