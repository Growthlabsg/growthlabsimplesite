...
export default function StatsSection() {
  ...
  const statsSchemas = stats.map((stat) =>
    getStatisticalPopulationSchema({
      name: stat.label,
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-white rounded-lg p-6 sm:p-8 lg:p-10 border border-slate-200 shadow-lg cursor-pointer overflow-hidden"
                  style={{
                    willChange: "transform, opacity",
                    backfaceVisibility: "hidden",
                    transform: "translateZ(0)",
